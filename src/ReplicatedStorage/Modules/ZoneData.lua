...
ZoneData.ZONES = {
	...
	},
	{
		...
		spawnEnemies = {
			...
			{ name = "Racooni Jandelini",    weight = 1,  wanderRange = 3, aggroRange = 5 },
		},
		spawnDensity = 0.012,
		leashRange   = 6,
	},
	{
		...
		spawnEnemies = {
			...
			{ name = "Frogo Elfo",            weight = 0.5,wanderRange = 3, aggroRange = 5 },
		},
		spawnDensity = 0.012,
		leashRange   = 6,
	},
	{
		...
		spawnEnemies = {
			...
			{ name = "Penguin Tree",          weight = 3,  wanderRange = 2, aggroRange = 5 },
	...
	},
	{
		...
		spawnEnemies = {
			...
			{ name = "Chimpazini Bananini",   weight = 12, wanderRange = 3, aggroRange = 5 },
			...
			{ name = "Blueberrini Octopusini",weight = 5,  wanderRange = 2, aggroRange = 5 },
			{ name = "Strawberelli Flamingelli", weight = 4, wanderRange = 2, aggroRange = 5 },
			...
			{ name = "Pi Pi Watermelon",      weight = 2,  wanderRange = 3, aggroRange = 5 },
			{ name = "Chocco Bunny",          weight = 1.5,wanderRange = 2, aggroRange = 5 },
			{ name = "Sealo Regalo",          weight = 1,  wanderRange = 2, aggroRange = 5 },
			{ name = "Cocosini Mama",         weight = 1,  wanderRange = 2, aggroRange = 5 },
